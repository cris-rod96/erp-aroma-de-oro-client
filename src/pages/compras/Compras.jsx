...
import { liquidacionAPI, productorAPI, ticketAPI } from '../../api/index.api'
...
const Compras = () => {
  ...
  const fetchDatos = async () => {
    setLoading(true)
    try {
      const [respTickets, respProductores, respLiq] = await Promise.all([
      ...
      <div className="w-full px-2 md:px-6 py-4 text-gray-800 bg-white font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="border-4 border-gray-800 p-4 bg-gray-50 shadow-md">
            ...
            <button className="w-full bg-gray-900 text-white font-black py-4 uppercase text-xs hover:bg-black transition-colors">
              Guardar Liquidación
            </button>
          </div>
        </div>
