      ...
      <div className="w-full px-2 md:px-6 py-4 text-gray-800 bg-white font-sans relative uppercase rounded-none">
        ...
        {error ? (
          ...
          <>
                ...
                <table className="w-full border-collapse text-left table-fixed">
                  <thead className="bg-gray-100 border-b border-black text-[10px] font-black uppercase text-center">
                    <tr>
                      ...
                      <th className="p-3 border-r border-black w-[10%]">U. RECIBE</th>
                      <th className="p-3 border-r border-black w-[10%]">U. PAGO</th>
                  ...
                  <tbody className="text-xs font-bold font-mono italic bg-white text-center">
                    <tr className="h-14">
                      ...
                      <td className="p-2 border-r border-black">
                        <select
                          className="w-full bg-transparent outline-none font-black uppercase text-[10px]"
                          value={unidad}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
              <div className="border border-black p-4 bg-gray-50 rounded-none">
                <h3 className="text-[11px] font-black underline italic uppercase mb-3">
                  02. FORMA DE PAGO Y RETENCIONES
                </h3>
                <div className="space-y-3">
                  {/* RETENCIÓN */}
              ...
              <div className="border border-black flex flex-col bg-white">
                <div className="p-4 flex-grow space-y-2.5 text-[11px] font-black uppercase">
                  ...
                  <div className="flex justify-between border-t border-dashed border-gray-300 pt-2 text-blue-600 italic">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {currentVentas.length > 0 ? (
                      ...
                      <tr>
                        <td
                          colSpan="10"
                          className="p-16 text-center text-gray-300 font-black italic uppercase bg-gray-50 tracking-widest text-xs"
                        >
