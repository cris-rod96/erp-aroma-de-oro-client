        ...
        const dibujarCopia = (startY, labelCopia) => {
          ...
          autoTable(doc, {
            ...
            body: [
              ...
              [
                ...
                { content: liq.Persona?.direccion || 'S/D', styles: { halign: 'center' } },
                { content: 'TELÉFONO:', styles: { fillColor: [250, 250, 250], halign: 'right' } },
                { content: liq.Persona?.telefono || 'N/A', styles: { halign: 'center' } },
              ],
            ],
          })
          ...
          autoTable(doc, {
            ...
            body: [
              [
                {
                  content: liq.DetalleLiquidacion?.descripcionProducto || 'CACAO SECO',
          ...
          autoTable(doc, {
            ...
            columnStyles: { 2: { halign: 'center', textColor: [0, 0, 0] } },
          })
